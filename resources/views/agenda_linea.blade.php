...
<?php
//$sql="Select cita,oc, distribucion, tipo_orden, manejo, fech_cita, digita_inicio, digita_final, rut_prov, rs, con_pred, sin_pred, evento, cancela_oc, cod_depto, decrip_depto from citas ";
//$c=mysql_query($sql);
//while($reg=mysql_fetch_array($c)){

foreach($cons_alinea as $reg)
{
$cita = $reg->cita;?>
