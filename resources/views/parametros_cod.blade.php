...
<div id="main">
  ...
  <div id="box-agenda">
    ...
    <form name="frmUpload" class="frmUpload" action="Upload.php" method="post" enctype="multipart/form-data">
      <ul>
    ...
    <form name="frmCrea" class="frmCrea" action="Parametros.php" method="post">
    ...
    <form name="frmCargar" class="frmCargar" action="Parametros.php" method="post">
    ...
    //          $link = mysqli_connect("localhost","root","1234","agenda");
       ...
       <li>
         ...
         <input type="text" name="txtSem" class="txtSem" value="<?php echo $arreglocapacidad['semana'];?>">
       </li>
       <li>
         <label for="">Sábado</label>
         <input type="text" name="txtSab" class="txtSab" value="<?php echo $arreglocapacidad['finde'];?>">
       </li>
       <li>
         <label for="">Tipo de manejo a modificar</label>
         <input type="text" name="txtTipo" class="txtTipo" readonly="readonly" value="<?php echo $arreglocapacidad['tipo_manejo'] ?> "/>
       </li>
       <li>
